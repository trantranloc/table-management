...
const EmployeeBookingPage: React.FC = () => {
    ...
    return (
        <div className="min-h-[calc(100vh-8rem)] flex flex-col items-center px-4 py-8 bg-gray-100">
            <h2 className="text-3xl font-semibold text-gray-800 mb-8">Staff Table Booking</h2>
            <div className="max-w-4xl w-full">
                    ...
                    {tables.map((table) => (
                        ...
                        >
                            ...
                            <button
                                ...
                                className={`mt-4 w-full py-2 px-4 rounded-md font-medium transition duration-200 ${table.status === 'AVAILABLE'
                ...
                {tables.filter((t) => t.status === 'AVAILABLE').length === 0 && (
                    <p className="text-center text-gray-600 mt-6">No available tables at the moment.</p>
                )}
                <Link
                    to="/booking"
